# NIST EDA 1.3.3.27.3.Spectral Plot: Sinusoidal Mode ####
# Date: 20260403
# Created by MATSUYOSHI Yasushi PCCPMDEV.JP
# Source: 
# page URL: 
#   https://www.itl.nist.gov/div898/handbook/eda/section3/eda33r3.htm
#   https://www.itl.nist.gov/div898/handbook/eda/section3/spectrum3.htm
# Data URL:
#   https://www.itl.nist.gov/div898/handbook/datasets/LEW.DAT
# 説明 ####
# NIST Statistic Handbook 1.3.3.27のスペクトル・プロット：正弦波モデル
# 
# デフォルト環境の保存と調整 ####
