# NIST EDA 1.3.3.27.2.Spectral Plot: Strong Autocorrelation and Autoregressive Model ####
# Date: 20260403
# Created by MATSUYOSHI Yasushi PCCPMDEV.JP
# Source: 
# page URL: 
#   https://www.itl.nist.gov/div898/handbook/eda/section3/eda33r2.htm
#   https://www.itl.nist.gov/div898/handbook/eda/section3/spectrum2.htm
# Data URL:
#   https://www.itl.nist.gov/div898/handbook/datasets/FLICKER.DAT
# 説明 ####
# NIST Statistic Handbook 1.3.3.27のスペクトル・プロット：強い自己相関、自己回帰モデル
# 
# デフォルト環境の保存と調整 ####
original_par <- par(no.readonly = TRUE)
par(mar = c(3,4,2.5,1), # プロットエリア外周余白の調整
...
mtext("スペクトル強度", side = 2, line = 3, las = 3)
# ピーク周波数の確認####
# 最もスペクトル密度が高い周波数を特定
