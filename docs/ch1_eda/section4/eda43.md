[原文 (Original English)](https://www.itl.nist.gov/div898/handbook/eda/section4/eda43.htm)  
閲覧(UTC)：2026-04-27 12:53:00  
...
Chatfield, C. (1989). *The Analysis of 
Time Series: An Introduction*, Fourth Edition,  Chapman &amp Hall, New York, NY.
...
Nelson, Wayne and Doganaksoy, Necip (1992), A Computer Program POWNOR for Fitting the Power-Normal and -Lognormal Models to Life or Strength Data from Specimens ofVarious Sizes, *NISTIR 4760*, U.S. Department of Commerce, National Institute of Standards and Technology.
...
Welch (1947), "The Generalization of 'Student's' Problem when Several Different Population Variances are Involved," *Biometrika*, Vol. 34, No. 1/2, pp. 28-35.

Welch (1951), "On the Comparison of Several Mean Values: An  Alternative Approach," *Biometrika*, 38, pp. 330-336.
